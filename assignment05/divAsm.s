...
*******************************************************************************/
    ...
    EXTERN sayhello       // myCstr defined outside this file.
...
divAsm
    PUSH {R0,LR}        // Push input argument and return address to stack
    LDR R0,= sayhello   // load (global) address of address of string into R0
